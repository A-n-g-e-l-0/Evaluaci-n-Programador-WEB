...
/**llenamos datamodel TiendaMtrix**/
...
function SeleccionaSucursales(Id_Tienda) {
    ...
    $.get("GetSucursales/?ID_Tienda="+Id_Tienda+"", function (data) {
        ...
        if (data.length > 0) {
            var contenido = "";
           // alert("Id Tienda :["+Id_Tienda +"]:"+ JSON.stringify(data));  // FUNCIONA 201023_1732  ES NECESARIO TRAER CON LOS NOMBRES DADOS DE ALTA EN EL MODEL
            for (var i = 0; i < data.length; i++) {
