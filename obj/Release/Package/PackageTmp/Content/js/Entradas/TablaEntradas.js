            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.length >= 1) {
                        ...
                        crearListadoEmpleadosqueChecan(["Empleado", "Sucursal", "Puesto", "Registro Entrada","Registro Salida","Detalles"], data)
                       // SeleccionaEmpleados();
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        for (var j = 0; j < llaves.length; j++) {
            ...
            if (valorllave == "IdRegistroEntrada" || valorllave == "IdEmpleado")
                ...
                contenido += "<td>" + formatDate(new Date(parseInt((data[i].RegistroEntrada).substr(6))), false) + "</td>";
            else if (valorllave == "RegistroSalida")
                contenido += "<td>" + formatDate(new Date(parseInt((data[i].RegistroSalida).substr(6))), false) + "</td>";
            else
