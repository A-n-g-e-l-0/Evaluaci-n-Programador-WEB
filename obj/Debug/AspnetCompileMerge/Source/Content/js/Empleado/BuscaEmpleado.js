...
$.get("ListarTiendas?IdTienda=0", function (data) {
...
function SeleccionaSucursalesxTienda(idEmpleado, val) {
    ...
    if (idEmpleado == 0) {
        $.get("ListarSucursales?IdTienda=" + val, function (data) {
        ...
        $.get("ListarTiendas?IdTienda=" + idEmpleado, function (data) {
            llenarCombo(data, document.getElementById("cboSucursalEleccion"), true);
        });
    }
...
function SeleccionaEmpleados() {
    ...
    if (iidTienda == 0) { //Selecciono el --- osea nada :D
        ...
        $.get("ListarEmpleadosxTienda/?IIdTienda=" + iidTienda, function (data) {
            crearListadoEmpleado(data);
 ...
 *
 * Ahora si es llamado por $get 210203_1218
 * @param {any} data
 */
...
function listar() {
    ...
    $.get("ListEmpleados", function (data) {
        crearListadoEmpleado(data);
    });
}
...
function myFunction() {
    ...
    if (!isEmpty(document.getElementById("txtNombre").value)) {
        ...
        $.get("BuscaEmpleado/?nombre=" + nombre, function (data) {
            crearListadoEmpleado(data);
        });
    }
}
