 ...
 * 210210_1651  sE MANDA A LLAMAR DESDE EL JAVASCRIPT EL LLENADO DE LA LISTA DE EMPLEADOS BAJA
 * @param {any} data
 */
...
function listar() {
    ...
    $.get("ListarEmpleadosBaja", function (data) {
        crearListadoBajasEmpleados(["Id","Empleado","Sucursal","Info"],data);
    });
}
...
/**
 * Crea el FRM que se convierte en el model2o a Enviar
 * */
